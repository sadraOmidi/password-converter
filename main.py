...
convert_password_to_hash_lable = tk.Label(text='convert password to hash : ', bg='grey', fg='white', height=3, width=25)
...
convert_hash_to_password_lable = tk.Label(text='convert hash to password : ', bg='grey', fg='white', height=3, width=25)
